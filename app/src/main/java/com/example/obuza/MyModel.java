...
import static com.example.obuza.MusicController.timeSong;
...
public class MyModel extends ViewModel {
    ...
    private MutableLiveData<List<Song>> list = new MutableLiveData<List<Song>>(new ArrayList<Song>());
...
//        int mins = mediaPlayer.getCurrentPosition() / 60000;
//        int secs = mediaPlayer.getCurrentPosition() / 1000;
//        if (secs < 59) {
//            timeSong.setText(mins + ":" + secs);
//        } else if (secs > 59 && secs < 119) {
//            timeSong.setText(mins + ":" + (secs - 60));
//        } else if (secs > 119 && secs < 179) {
//            timeSong.setText(mins + ":" + (secs - 120));
//        } else if (secs > 179 && secs < 239) {
//            timeSong.setText(mins + ":" + (secs - 180));
//        }
